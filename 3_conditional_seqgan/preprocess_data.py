...
def create_sequence(seq_length, type_dict):
    ...
    _save_pickle("./data/pk_pre_type_data.pkl", type_data)
...
def data_to_index(datadict, pos2idx):
    ...
    _save_pickle("./data/pk_type_data_index.pkl", idx_dict)

    # save pk_data_index.txt
    f = open('./data/pk_type_data_index.txt', 'w')
...
if __name__ == "__main__":
    ...
    # load after dataset
    a = open("./data/pk_pre_type_data.pkl", 'rb')
